package miehex_revolution.utils
...
abstract class Miehex_revolutionModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<Miehex_revolutionModDependenciesExtension>("miehex_revolutionModDependencies")
